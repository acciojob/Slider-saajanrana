...
const Review = () => {
  ...
  return (
    <div className="section-center" id="review-container">
      {people.map((person, personIndex) => {
        ...
        return (
          <article className={position} key={id} >
            <img src={image} alt={name} className="person-img" id={`person-${personIndex}-image`}/>
            <h4 id={`person-${personIndex}`}>{name}</h4>
